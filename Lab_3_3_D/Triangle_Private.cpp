...
Triangle_Private::Triangle_Private(const double A, const double B, const double C)
{
...
istream& operator >>(istream& in, Triangle_Private& s)
{
	double a, b, c;
	cout << "a = "; in >> a;
	cout << "b = "; in >> b;
	...
	{
		s.SetA(0); s.SetB(0); s.SetC(0);
	}
	return in;
}

Triangle_Private& Triangle_Private::operator --()
{
...
Triangle_Private Triangle_Private::operator --(int)
{
