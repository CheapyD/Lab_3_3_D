...
Triangle_Public::Triangle_Public(const double A, const double B, const double C)
{
...
Triangle_Public& Triangle_Public::operator --()
{
...
Triangle_Public Triangle_Public::operator --(int)
{
